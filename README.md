...
- Дожим через 4 часа, если классификатор поймал «ушёл думать», и только с 09:00 до 18:00 МСК.
...
Промпты: `prompts/classifier.txt`, `prompts/manager.txt`, `prompts/company_facts.txt`.
